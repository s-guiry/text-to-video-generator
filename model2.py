...
def noise_predictor(input_shape, label_shape, timestep_shape):
    ...
    reshaped_label = tf.reshape(label_inputs, (1, 1, 1, 1, 512))
    reshaped_label_tiled = tf.tile(reshaped_label, [None, 50, 224, 224, 1])
    
    reshaped_timestep = tf.reshape(timestep_inputs, (1, 1, 1, 1, 1))
    reshaped_timestep_tiled = tf.tile(reshaped_timestep, [None, 50, 224, 224, 1])
